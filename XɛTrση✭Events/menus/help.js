    ...
    if (interaction.values[0] === "XɛTrση_Settings") {
      ...
      await msg.edit({
        embeds: [
          ...
          .addField(`📜**\`ASS\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*ass**`, true)
          .addField(`📜**\`BDSM\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*bdsm**`, true)
          .addField(`📜**\`BLOWJOB\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*blowjob**`, true)
          .addField(`📜**\`BOOB\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*boobs**`, true)
          .addField(`📜**\`CREAMPIE\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*creampie**`, true)
          .addField(`📜**\`CUM\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*cum**`, true)
          .addField(`📜**\`CUMSLUTS\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*cumsluts**`, true)
          .addField(`📜**\`DANBOORU\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*danbooru**`, true)
          .addField(`📜**\`DOUJIN\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*doujin**`, true)
          .addField(`📜**\`EROKEMO\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*erokemo**`, true)
          .addField(`📜**\`FEETGIF\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*feetgif**`, true)
          .addField(`📜**\`FEMDOM\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*femdom**`, true)
          .addField(`📜**\`GANGBANG\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*gangbang**`, true)
          .addField(`📜**\`GONEWILD\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*gonewild**`, true)
          .addField(`📜**\`HENTAI\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*hentai**`, true)
          .addField(`📜**\`HENTAIASS\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*hentaiass**`, true)
          .addField(`📜**\`HENTAITHIGH\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*hentaithigh**`, true)
          .addField(`📜**\`KITSUNE\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*kitsune**`, true)
          .addField(`📜**\`LEWD\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*lewd**`, true)
          .addField(`📜**\`MAID\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*maid**`, true)
          .addField(`📜**\`MILF\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*milf**`, true)
          .addField(`📜**\`NGIF\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*ngif**`, true)
          ...
          .addField(`📜**\`ORGY\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*orgy**`, true)
          .addField(`📜**\`PANTY\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*panty**`, true)
          .addField(`📜**\`PORNGIF\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*porngif**`, true)
          .addField(`📜**\`PUBLIC\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*public**`, true)
          .addField(`📜**\`PUSSY\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*pussy**`, true)
          .addField(`📜**\`RANDOM\`⮐**`, `**⧪ Human(yes)\nHentai!(yes)⪢ *\`${PREFIX}\`*random**`, true)
          .addField(`📜**\`THIGH\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*thigh**`, true)
          .addField(`📜**\`VAGINA\`⮐**`, `**⧪ NSFW⪢\n*\`${PREFIX}\`*vagina**`, true),
        ],
      });
